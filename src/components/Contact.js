  ...
  class Contact extends React.Component{
    ...
    render() {        
      return(
        ...
        <div className="formx">
          <div className="htp">
            <h5 id="send">Send a message</h5>
            <h6 id="gig">Fill the form below with the inquiries you may have and we would get back to you as sonn as possible</h6>
          </div>
          <div className="form">  
            <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
              <div className="form-group">
                <label htmlFor="name">Name</label>
                <input type="text" className="form-control" id="name" value={this.state.name} onChange={(name)=>this.onNameChange(name)}/>
              </div>
              <div className="form-group">
                  <label htmlFor="InputEmail1">Email address</label>
                  <input type="email" className="form-control" aria-describedby="emailHelp" id="email" value={this.state.email} onChange={(email)=>this.onEmailChange(email)} />
              </div>
              <div className="form-group">
                <label htmlFor="message">Message</label>
                <textarea className="form-control" rows="5" id="message" value={this.state.message} onChange={(msg)=>this.onMessageChange(msg)}></textarea>
              </div>
          ...
          <div className="row">
            ...
            <div className="soc col-sm-6 col-lg-3 col-md-6 offset-sm-0 offset-lg-0 offset-md-0">
              ...
              <Link to='/register'><button className="bttn" type="submit" style={{ width:"180px", height:"43px", borderRadius:"4px",outline:"none"}}>
                <h6 className="news" >Sign Up</h6></button>
              </Link>
            </div>
